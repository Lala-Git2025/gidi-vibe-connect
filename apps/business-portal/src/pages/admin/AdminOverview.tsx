      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            <a href="/admin/venues" className="p-4 border rounded-lg hover:bg-accent transition-colors block">
              <Building2 className="h-6 w-6 mb-2 text-amber-500" />
              <h3 className="font-semibold">Manage Venues</h3>
              <p className="text-sm text-muted-foreground">View, promote, or flag any venue</p>
            </a>
            <a href="/admin/promotions" className="p-4 border rounded-lg hover:bg-accent transition-colors block">
            ...
            <a href="/admin/users" className="p-4 border rounded-lg hover:bg-accent transition-colors block">
